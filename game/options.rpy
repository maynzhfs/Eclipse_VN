...
define config.name = _("MissingRed_Renpy_Template")
...
define build.name = "MissingRed_Renpy_Template"
...
define config.save_directory = "MissingRed_Renpy_Template-1765149853"
